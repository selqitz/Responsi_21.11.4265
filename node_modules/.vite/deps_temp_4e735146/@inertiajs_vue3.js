...
var X2 = defineComponent({ props: { title: { type: String, required: false } }, data() {
  ...
  let o = e.type && e.type.toString();
  return typeof e.type == "function" ? this.resolveNode(e.type()) : typeof e.type == "object" ? (console.warn("Using components in the <Head> component is not supported."), []) : /(fragment|fgt)/i.test(o) && e.children ? e.children.flatMap((n) => this.resolveNode(n)) : /(comment|cmt)/i.test(o) ? [] : e;
} }, render() {
